...
## Policies:
Any software component (proprietary, third-party, or open source) that makes its way into this project, has to review the License obligations and be compatible with the License. In addition, all software must be audited and reviewed, including all proprietary software components.
